...
class TableData {
    ...
    private ArrayList<Student> tableData;
    ...
    public void setTableData(ArrayList<Student> tableData) {
...
//        TableData test = gson.fromJson(s,
//                new TypeToken<TableData>() {
//                }.getType());
        
        TableData test = gson.fromJson(s,TableData.class);
